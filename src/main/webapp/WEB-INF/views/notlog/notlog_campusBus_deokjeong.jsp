<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<!-- notlog_campusBus_deokjeong.jsp -->
		...
		<hr color="gray" width="80%">
			<table width="80%" align="center" border="1">
				<tr align="center" border="1">
					...
					<td><a href="notlog_campusBus_deokjeong.do"><button style="background-color:#adc6f0;" class="borderless-button full-width-button cell-button">덕정/잠실</button></a></td>
