...
<html>
	...
	<body>
		...
		<hr color="gray" width="80%">
			<table width="80%" align="center" border="1">
				<tr align="center" border="1">
					...
					<td ><a href="notlog_campusBus_gyeonggi.do"><button style="background-color:#adc6f0;" class="borderless-button full-width-button cell-button">경기/서부</button></a></td>
			...
			<table width="80%" align="center" border="1">
				<tr><td><h3>이젠대학교 통학버스 이용 안내</h3></td></tr>
		...
		<h3 align="center">&nbsp;&nbsp;대화/백석</h3>
		<hr color="gray" width="80%">
			<table class="table table-bordered custom-table" width="80%" border="1">
				<tr align="center">
					<td style="background-color:#dfe3eb;" width="20%">대화노선</td>
					<td width="60%">장기역(07:50)(1대) - 종합운동장 주차장 옆(서구청 옆) - 학교</td>
				</tr>
				<tr align="center">
					<td style="background-color:#dfe3eb;" width="20%">백석노선</td>
					<td width="60%">백석역(1번 출구) - 학교</td>
				</tr>
				<tr align="center">
					<td style="background-color:#dfe3eb;" width="20%" >요금 안내(편도)</td>
					<td width="60%">3,500원 / 약 60-70분</td>
				</tr>	
			</table>	
