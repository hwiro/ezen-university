<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<!-- notloig_eventBoardList_Content.jsp -->
...
<br><br><br><br><br><br>
	<table width="80%"  class="table table-bordered">
		...
		<tr>
			<td colspan="6" align="center"><img src="resources/infoBoard_img/${dto.image}" width="100%" height="600px"></td>
		</tr>		
	</table>
    <br>
	<div align="center">
		<table border="1" width="150" height="40">
			<tr align="center">
        		<td>
        			<a href="notlog_eventBoardList.do?page=1">목록</a>
        		</td>
        	</tr>
        </table>
	</div>
