	...
	<br><br><br><br>
		...
		<hr color="gray" width="80%">
			<table width="80%" align="center" border="1">
				<tr align="center">
					<td><a href="notlog_campusBus_seoul.do"><button style="background-color:#adc6f0;" class="borderless-button full-width-button cell-button">서울강북</button></a></td>
					...
					<td><a href="notlog_campusBus_Namyangju.do"><button style="background-color:#ccdfeb;" class="borderless-button full-width-button cell-button">남양주</button></a></td>
				</tr>
			</table>
			...
			<table width="80%" border="1" align="center">
				...
				<tr><td>&nbsp;-&nbsp;재학생/교직원 모두 이용 가능 합니다.</td>
						<td rowspan="9"><input type="image" src="resources/img/buscard.png" alt="셔틀버스카드 이미지" width="340px" height="240px"></td></tr>
			...
			<br><br><br>
			<h3 align="center">&nbsp;&nbsp;장암/중화/태릉/하계</h3>
			<hr color="gray" width="80%">
			
			<table class="table table-bordered custom-table" width="80%" border="1">
				<tr align="center">
					<td style="background-color:#dfe3eb;" width="16%">장암노선</td>
					<td width="70%">장암역1번출구 - 학교</td>
				</tr>
				<tr align="center">
					<td style="background-color:#dfe3eb;" width="16%">중화노선</td>
					<td width="70%">중화역 1번출구 - 학교</td>
				</tr>
				<tr align="center">
					<td style="background-color:#dfe3eb;" width="16%">태릉노선</td>
					<td width="70%">태릉역 5번 출구 - 학교</td>
				</tr>
				<tr align="center">
					<td style="background-color:#dfe3eb;" width="16%">하계노선</td>
					<td width="70%">하계역 정류장 - 학교</td>
				</tr>
				<tr align="center">
					<td style="background-color:#dfe3eb;" width="16%" >요금 안내</td>
					<td width="80%">2,300원 / 약 40-60분 소요</td>
				</tr>
