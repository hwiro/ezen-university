...
<div class="card">
            <div class="card-body">
              ...
              <form name="f" action="update_notice_board.do" method="post" enctype="multipart/form-data" onsubmit="return check()">
              <input type="hidden" name="major_notice_board_code" value="${getBoard.major_notice_board_code }">
                <div class="col-md-12">
                ...
                <div class="text-center">
                  ...
                  <a href="noticeBoard.do"><button type="button" class="btn btn-secondary">취소</button></a>
                </div>
              </form>
            </div>
          </div>
