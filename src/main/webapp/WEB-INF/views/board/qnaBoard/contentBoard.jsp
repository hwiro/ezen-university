...
<div class="card">
				...
				<article class="box page-content">
					<header>
						...
						<ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow"
							...
							<li><a class="dropdown-item" href="update_qna_board.do?major_qna_board_code=${getBoard.major_qna_board_code}">수정</a>
							</li>
							<li><a class="dropdown-item" href="delete_qna_board.do?major_qna_board_code=${getBoard.major_qna_board_code}&image=${getBoard.image }">삭제</a>
							</li>
						</ul>
						</c:if>
						<ul class="meta">
					...
					<section>
						...
						<c:forEach var="dto" items="${listFile}">
							<a href="qnaBoard_download.do?major_qna_board_code=${getBoard.major_qna_board_code }&name=${dto.save_name }">${dto.original_name }</a>
						</c:forEach>
						</div>
					</section>
				</article>
	...
	<section>
		<div align="right">
			<c:if test="${getBoard.re_level eq 0 && sessionScope.type eq '교수'}">
				<button type="button" class="btn btn-outline-primary"
					onclick="window.location='write_qna_board.do?major_qna_board_code=${getBoard.major_qna_board_code}'">답글작성
				</button>&nbsp&nbsp&nbsp&nbsp 
			</c:if>
			<button type="button" class="btn btn-outline-primary" onclick="window.location='qnaBoard.do'">글목록</button>
		</div>
	</section>
</body>
...
<form name="f" action="delete_qna_board.do" method= "post">
