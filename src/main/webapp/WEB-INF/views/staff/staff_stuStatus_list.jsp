...
<div class="pagetitle">
	...
	<nav>
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active">학생 학적정보</li>
		</ol>
	</nav>
</div>
<!-- End Page Title -->
<div class="card">
	<section class="section">
		<div class="row">
			<div class="card-body">
				<h5 class="card-title">학적정보 조회</h5>
				<div style="display: flex; justify-content: space-between;">
					<form style="display: flex;" name="f" action="Staff_stuStatus_findId.do" method="post">
					...
					<form name="f" action="Staff_stuStatus_list.do?page=1" method="post">
						...
						<c:if test="${listStudent != null || listStudent.size() != 0}">
							<c:forEach var="asdto" items="${listStudent}">
								<tr>
									...
									<td>${asdto.status}</td>
									<td><a
										href="Staff_stuStatus_edit.do?student_id=${asdto.student_id}">수정</a></td>
								</tr>
							</c:forEach>
						</c:if>
