...
<div class="co-lg-6">
		...
		<div class="card-body">
			...
			<c:forEach var="dto" items="${listMajorBoard}">
					<tr>
						...
						<td><a
							href="admin_content_major_board.do?major_board_code=${dto.major_board_code}">${dto.subject}&nbsp;</a><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chat-left-dots" viewBox="0 0 16 16">
  ...
  <path d="M5 6a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm4 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm4 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0z"/>
			...
			<br>
			<div align="right">
				<a href="admin_write_major_board.do">
			...
			<c:if test="${count>0}">
				<ul class="pagination justify-content-center">
					<li class="page-item"><c:if test="${startPage > pageBlock}">
							<a class="page-link"
								href="admin_majorBoard.do?pageNum=${startPage-pageBlock}"
								tabindex="-1" aria-disabled="true">이전</a>
						</c:if></li>
					<c:forEach var="i" begin="${startPage}" end="${endPage}">
						<li class="page-item"><a class="page-link"
							href="admin_majorBoard.do?pageNum=${i}">${i}</a></li>
					</c:forEach>
					<li class="page-item">
						<c:if test="${endPage < pageCount}">
							<a class="page-link" href="admin_majorBoard.do?pageNum=${startPage+pageBlock}">다음</a>
						</c:if>
					</li>
				</ul>
			</c:if>
